...
@section('title', 'Tambah Data Tenant - SIKANTEL')
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <div class="flex items-center space-x-2 text-sm text-gray-500 mb-2">
                ...
                <span class="text-gray-900 font-semibold">Tambah Tenant Baru</span>
            </div>
            <h1 class="text-[26px] font-bold text-gray-900 tracking-tight">Tambah Tenant Baru</h1>
        </div>
    </div>

    <div class="bg-white rounded-[20px] shadow-sm border border-gray-100 overflow-hidden max-w-4xl">
        <div class="p-8">
            <form action="{{ route('pengelola.tenant.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_tenant" id="nama_tenant" required placeholder="Contoh: Ayam Geprek Sa'i" value="{{ old('nama_tenant') }}" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="jenis_makanan" id="jenis_makanan" required class="w-full px-4 py-3 bg-white rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-telkom-red/20 focus:border-telkom-red appearance-none cursor-pointer transition-all @error('jenis_makanan') border-red-500 ring-red-100 @enderror">
                                <option value="" disabled {{ old('jenis_makanan') ? '' : 'selected' }}>-- Pilih Jenis Tenant --</option>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="nik" id="nik" placeholder="Contoh: 327000111222333" value="{{ old('nik') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="no_telepon" id="no_telepon" required placeholder="Contoh: 081234567890" value="{{ old('no_telepon') }}" 
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" id="address" rows="3" placeholder="Contoh: Jl. Telekomunikasi No. 1..." 
                               class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-telkom-red/20 focus:border-telkom-red transition-all @error('address') border-red-500 ring-red-100 @enderror">{{ old('address') }}</textarea>
                        @error('address')
                            <p class="mt-1.5 text-sm text-red-500 font-medium">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_name" id="bank_name" placeholder="Contoh: BCA, Mandiri, BNI" value="{{ old('bank_name') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_account_number" id="bank_account_number" placeholder="Contoh: 1234567890" value="{{ old('bank_account_number') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_account_name" id="bank_account_name" placeholder="Contoh: Jhon Doe" value="{{ old('bank_account_name') }}" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <p class="mt-1.5 text-[13px] text-gray-500">Format: PDF, JPG, PNG (Maks 2MB).</p>
                        @error('ktp_document')
                            <p class="mt-1.5 text-sm text-red-500 font-medium">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="pt-6 border-t border-gray-100 flex items-center justify-end space-x-3">
                    ...
                    <button type="submit" class="px-6 py-2.5 rounded-xl text-sm font-bold text-white bg-telkom-red hover:bg-telkom-maroon shadow-sm transition-colors">Simpan Tenant</button>
                </div>
            </form>
        </div>
    </div>

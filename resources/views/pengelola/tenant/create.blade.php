        ...
        <div class="p-8">
            <form action="{{ route('pengelola.tenant.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <!-- No Telepon -->
                    <div>
                        <label for="no_telepon" class="block text-sm font-semibold text-gray-700 mb-2">Nomor Telepon <span class="text-telkom-red">*</span></label>
                ...
                <h2 class="text-lg font-bold text-gray-900 mb-6 border-b border-gray-100 pb-3">Logo / Foto Profil Tenant (Opsional)</h2>
                <div class="mb-8">
                    <!-- Foto Thumbnail -->
                    <div>
                        <!-- Upload Area -->

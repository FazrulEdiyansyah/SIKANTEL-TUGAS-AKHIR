                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8" x-data="menuForm()">
                    ...
                    <div class="lg:col-span-7 flex flex-col gap-6">
                        ...
                        <div class="pt-2 relative">
                            <input type="checkbox" id="is_customizable" name="is_customizable" value="1" {{ old('is_customizable') ? 'checked' : '' }} class="peer absolute top-0 left-0 w-5 h-5 text-telkom-red border-gray-300 rounded focus:ring-telkom-red transition-colors cursor-pointer">
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('menuForm', () => ({
                ...
                imageUrl: null,
                customizations: @json(old('customizations', [])),

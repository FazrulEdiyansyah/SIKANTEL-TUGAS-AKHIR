...
@section('title', 'Riwayat Persetujuan Kabag - Approver')
...
@section('content')
    ...
    <div class="bg-white rounded-[20px] shadow-sm border border-gray-100 overflow-hidden flex flex-col">
        ...
        <!-- Filter & Search Bar -->
        <form method="GET" action="{{ route('kabag.riwayat') }}" class="p-6 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <!-- Search -->

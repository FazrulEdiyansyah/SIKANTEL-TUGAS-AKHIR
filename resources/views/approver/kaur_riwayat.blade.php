...
@section('title', 'Riwayat Persetujuan Kaur - Approver')
...
@section('content')
    <!-- Header Page -->
    <div class="mb-8">
        <h1 class="text-[26px] font-bold text-gray-900 tracking-tight mb-1">Riwayat Persetujuan (Kaur)</h1>
        <p class="text-[15px] text-gray-500 font-medium">Daftar riwayat laporan pencairan dana yang telah diproses oleh Kaur.</p>
    </div>
    ...
    <div class="bg-white rounded-[20px] shadow-sm border border-gray-100 overflow-hidden flex flex-col">
        ...
        <!-- Filter & Search Bar -->
        <form method="GET" action="{{ route('kaur.riwayat') }}" class="p-6 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <!-- Search -->
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="py-4 px-6 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('kaur.pencairan.show', $p->batch_id) }}?source=riwayat" class="px-3 py-1.5 text-xs font-bold text-telkom-red border border-red-200 rounded-lg hover:bg-red-50 transition-colors inline-flex items-center justify-center">
